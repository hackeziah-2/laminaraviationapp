          ...
          <div className="relative space-y-4 px-6 py-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border-2 border-gray-300 px-3 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-300"
